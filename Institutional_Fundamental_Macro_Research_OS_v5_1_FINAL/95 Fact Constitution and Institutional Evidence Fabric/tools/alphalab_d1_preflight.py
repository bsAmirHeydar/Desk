...
if m.get('current_stack')!='V17.0.0': errors.append('CURRENT_STACK_NOT_V17_D1')
if m.get('fact_constitution_version')!='1.0.0': errors.append('FACT_CONSTITUTION_VERSION_MISMATCH')
