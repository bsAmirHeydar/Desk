...
if m.get('current_stack') not in {'V17.0.0','V18.0.0','V19.0.0','V20.0.0'}: errors.append('CURRENT_STACK_NOT_V17_V18_V19_OR_V20')
expected_fc={'V17.0.0':'1.0.0','V18.0.0':'1.1.0','V19.0.0':'1.1.0','V20.0.0':'1.1.0'}.get(m.get('current_stack'))
