---
title: "Universal Daily Reporting Workflow"
type: canonical-note
status: canonical
version: 13.0.0
created: 2026-08-06
...
---
# Universal Daily Reporting Workflow

## Mission

Operationalize **Universal Daily Reporting Workflow** as a reusable V13 component for universal FX, commodity and global-index research.

## Governing doctrine

The universal layer must resolve the market object before analysis and must separate architectural support from actual data availability. Large universes must use Tier 1 executive scan, Tier 2 flagged instruments and Tier 3 deep analysis under a predeclared selection rule.

## Required state

The analyst must capture identity, metadata, coverage, routing, calendars, sources and cross-asset dependencies. Every load-bearing field must include value or band, horizon, timestamp, vintage, provenance, confidence and next-update condition.
