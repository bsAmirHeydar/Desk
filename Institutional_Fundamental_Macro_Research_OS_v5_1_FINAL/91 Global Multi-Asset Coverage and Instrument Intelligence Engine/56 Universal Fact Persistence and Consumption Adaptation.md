---
title: "Universal Fact Persistence and Consumption Adaptation"
type: canonical-note
status: canonical
version: 13.0.0
created: 2026-08-06
...
---
# Universal Fact Persistence and Consumption Adaptation

## Mission

Operationalize **Universal Fact Persistence and Consumption Adaptation** as a reusable V13 component for universal FX, commodity and global-index research.

## Governing doctrine

The shared science must keep fact strength separate from attention, and narrative dominance separate from narrative validity.

## Required state

The analyst must capture V11 force, persistence, consumption, remaining pressure and asymmetry together with V12 attention, narrative validity, dominance and transition. Every load-bearing field must include value or band, horizon, timestamp, vintage, provenance, confidence and next-update condition.
