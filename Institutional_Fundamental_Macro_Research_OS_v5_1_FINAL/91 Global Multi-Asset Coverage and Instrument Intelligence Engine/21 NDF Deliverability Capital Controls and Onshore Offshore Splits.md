---
title: "NDF Deliverability Capital Controls and Onshore Offshore Splits"
type: canonical-note
status: canonical
version: 13.0.0
created: 2026-08-06
...
---
# NDF Deliverability Capital Controls and Onshore Offshore Splits

## Mission

Operationalize **NDF Deliverability Capital Controls and Onshore Offshore Splits** as a reusable V13 component for universal FX, commodity and global-index research.

## Governing doctrine

FX is bilateral relative value. A valid conclusion requires two currency blocks plus shared global factors and pair-specific market structure. Deliverability, fixing convention, capital controls and onshore/offshore segmentation are mandatory.

## Required state

The analyst must capture both currency legs, policy, real rates, growth, inflation, fiscal and external balance, reserves, carry, basis, hedging, intervention, convertibility and fixings. Every load-bearing field must include value or band, horizon, timestamp, vintage, provenance, confidence and next-update condition.
