---
title: "Single-Instrument Full Report Standard"
type: canonical-note
status: canonical
version: 13.0.0
created: 2026-08-06
...
---
# Single-Instrument Full Report Standard

## Mission

Operationalize **Single-Instrument Full Report Standard** as a reusable V13 component for universal FX, commodity and global-index research.

## Governing doctrine

Common fields may be compared only when their semantics, horizon and scoring mode match; specialist state remains adapter-specific.

## Required state

The analyst must capture single-instrument, watchlist, dashboard, ranking and family-specific daily output with explicit depth control. Every load-bearing field must include value or band, horizon, timestamp, vintage, provenance, confidence and next-update condition.
