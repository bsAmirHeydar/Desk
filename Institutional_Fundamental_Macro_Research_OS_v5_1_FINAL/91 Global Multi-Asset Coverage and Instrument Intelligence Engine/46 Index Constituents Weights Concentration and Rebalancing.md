---
title: "Index Constituents Weights Concentration and Rebalancing"
type: canonical-note
status: canonical
version: 13.0.0
created: 2026-08-06
...
---
# Index Constituents Weights Concentration and Rebalancing

## Mission

Operationalize **Index Constituents Weights Concentration and Rebalancing** as a reusable V13 component for universal FX, commodity and global-index research.

## Governing doctrine

An index is a rules-based portfolio. Its economic exposure and mechanical demand depend on methodology and historical composition. Announcement date, effective date and point-in-time weights must be stored separately.

## Required state

The analyst must capture provider methodology, return type, point-in-time constituents and weights, earnings, valuation, currency, concentration, breadth, flows and rebalancing. Every load-bearing field must include value or band, horizon, timestamp, vintage, provenance, confidence and next-update condition.
