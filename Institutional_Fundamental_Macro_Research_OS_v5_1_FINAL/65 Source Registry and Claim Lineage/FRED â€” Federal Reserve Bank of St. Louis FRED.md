---
title: "FRED — Federal Reserve Bank of St. Louis FRED"
type: source
status: evergreen
version: 5.0.0
created: 2026-07-29
...
Economic and financial time series; use vintage controls in historical tests.
...
```text
[FRED; series/table=<identifier>; reference=<period>;
