...
canonical_url: "https://www.sec.gov/edgar/search-and-access"
---
# SEC_EDGAR — SEC EDGAR
...
Public-company filings, financial statements, disclosures, and securities documents.
...
```text
[SEC_EDGAR; series/table=<identifier>; reference=<period>;
