---
title: "COINMETRICS — Coin Metrics Network Data"
type: source
status: evergreen
version: 5.0.0
created: 2026-07-29
...
tags:
  ...
  - official-source
  - coinmetrics
source_key: "COINMETRICS"
canonical_url: "https://coinmetrics.io/community-network-data/"
---
...
Crypto network, market, supply, transaction, and realized-cap metrics.
...
```text
[COINMETRICS; series/table=<identifier>; reference=<period>;
