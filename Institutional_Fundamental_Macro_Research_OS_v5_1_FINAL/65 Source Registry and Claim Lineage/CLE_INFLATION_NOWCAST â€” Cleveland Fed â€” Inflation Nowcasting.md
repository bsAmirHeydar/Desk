---
title: "CLE_INFLATION_NOWCAST — Cleveland Fed — Inflation Nowcasting"
type: source
status: evergreen
version: 5.0.0
created: 2026-07-29
...
tags:
  - source-registry
  - official-source
  - cle-inflation-nowcast
source_key: "CLE_INFLATION_NOWCAST"
canonical_url: "https://www.clevelandfed.org/indicators-and-data/inflation-nowcasting"
---
...
Current-month inflation nowcasts.
...
```text
[CLE_INFLATION_NOWCAST; series/table=<identifier>; reference=<period>;
