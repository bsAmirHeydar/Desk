---
title: "Swing Context for Two-to-Ten-Day Holds"
type: field-guide
status: evergreen
version: 5.0.0
created: 2026-07-29
...
tags:
  - 05-timeframes
  - swing-context-for-two-to-ten-day-holds
  - institutional-fundamental
---
# Swing Context for Two-to-Ten-Day Holds

> [!abstract] Research mandate
> Construct a point-in-time, source-controlled, model-aware and falsifiable understanding of **Swing Context for Two-to-Ten-Day Holds**. Canonical doctrine is linked; this note contains the topic-specific research object.
...
1. What exact state or mechanism does **Swing Context for Two-to-Ten-Day Holds** represent, in what unit, population, instrument, and convention?
2. Which **Swing Context for Two-to-Ten-Day Holds** observations existed at the decision cutoff, which are estimates, and which are revised?
3. What distribution about **Swing Context for Two-to-Ten-Day Holds** is embedded in consensus, curves, options, valuation, positioning, or physical basis?
4. Which market or variable must lead if the proposed **Swing Context for Two-to-Ten-Day Holds** mechanism is active?
5. What rival model can create the same target move while **Swing Context for Two-to-Ten-Day Holds** is unchanged?
6. How do regime, horizon, positioning, liquidity, carry, and implementation alter the payoff?
7. Which predeclared evidence rejects, caps, or expires the **Swing Context for Two-to-Ten-Day Holds** decision?
...
For **Swing Context for Two-to-Ten-Day Holds**, document every variable, unit, convention, sample, parameter, regularizer, and uncertainty estimate. An identity constrains possible stories; it does not estimate an elasticity or prove a causal channel.

## Measurement architecture

- **Measurement 1 for Swing Context for Two-to-Ten-Day Holds:** inherited higher-horizon state.
...
- **Model layer 1 for Swing Context for Two-to-Ten-Day Holds:** scenario trees.
- **Model layer 2 for Swing Context for Two-to-Ten-Day Holds:** event studies.
- **Model layer 3 for Swing Context for Two-to-Ten-Day Holds:** cross-asset confirmation matrices.
- **Model layer 4 for Swing Context for Two-to-Ten-Day Holds:** permission classification.
- **Model layer 5 for Swing Context for Two-to-Ten-Day Holds:** post-trade causal attribution.

Validate the **Swing Context for Two-to-Ten-Day Holds** stack against simple point-in-time benchmarks. Report forecast/density error, probability calibration, regime stability, vintage sensitivity, feature ablation, latency, cost, and economic value. Register implementation under [[00 Core Standards/14 Model Card Standard]].
...
- **Failure test 1 for Swing Context for Two-to-Ten-Day Holds:** using fundamentals as entry timing.
...
This material survived consolidation because it contains subject-specific instruction for **Swing Context for Two-to-Ten-Day Holds**, not the former repeated institutional wrapper.

## Objective

A short swing captures a repricing process that is unlikely to finish in one session.

Typical drivers:

- policy-path convergence;
- multi-release growth/inflation sequence;
- earnings revision wave;
- fiscal supply or term-premium repricing;
- commodity balance change;
- positioning unwind;
- geopolitical risk-premium change.

## Swing Thesis Requirements

1. **Mispricing:** Define the expectation gap.
2. **Catalyst sequence:** More than one path to convergence.
3. **Persistence:** Explain why the driver lasts days.
...
A day trade may convert only when all were defined before entry:

- swing thesis existed;
...
Rates, earnings, FX, commodity curve, volatility.

### Positioning

Crowding, potential squeeze, liquidation risk.
...
## Example: Gold Long Swing

- Market prices sticky policy.
- Inflation trend softens.
- real yields begin falling.
- dollar weakens.
...
- Market prices benign cuts.
- inflation persistence returns.
- real yields rise.
...
A thesis can be wrong by delay. Define:

- catalyst date;
- expected reaction window;
- maximum number of sessions without follow-through.

If the market does not respond despite confirming information, the lack of response is evidence.

## Weekend Risk

Geopolitics, policy announcements, earnings, and liquidity gaps can create discontinuous moves. Reduce size or avoid holding when the thesis cannot survive a plausible gap.

---

## Primary source routes for Swing Context for Two-to-Ten-Day Holds
