---
title: "Investment Committee Decision Record Template"
type: template
status: evergreen
version: 5.0.0
created: 2026-07-29
...
language: en
tags:
  - 62-institutional-templates-schemas-and-control-checklists
  - investment-committee-decision-record-template
...
```yaml
template: "Investment Committee Decision Record Template"
as_of:
information_cutoff:
decision_owner:
asset:
