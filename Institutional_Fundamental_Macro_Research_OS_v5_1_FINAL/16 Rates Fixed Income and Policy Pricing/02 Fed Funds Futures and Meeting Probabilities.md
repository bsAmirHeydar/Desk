...
- Identify the new **Fed Funds Futures and Meeting Probabilities** information since the prior close and its source timestamp.
- Reconstruct the priced **Fed Funds Futures and Meeting Probabilities** baseline before reading the target move.
- Name the liquid leader closest to the **Fed Funds Futures and Meeting Probabilities** mechanism and one independent confirmation.
- Compare observed transmission with the **Fed Funds Futures and Meeting Probabilities** event/quiet-day historical distribution.
- Assign a permission and a confidence cap; record the **Fed Funds Futures and Meeting Probabilities** cancellation condition.
- Pass only the permission, leader, invalidation, expiry, and size ceiling to technical execution.

For **Fed Funds Futures and Meeting Probabilities**, fundamentals restrict the allowed trade set; they do not supply the candle trigger or authorize widening a structural stop.

## Two-to-ten-day swing translation

- Define the still-open **Fed Funds Futures and Meeting Probabilities** pricing gap rather than the general narrative.
- Estimate the **Fed Funds Futures and Meeting Probabilities** impulse half-life and its uncertainty by regime.
- Map catalysts capable of confirming, reversing, or exhausting the **Fed Funds Futures and Meeting Probabilities** campaign.
- Compare outright and relative expressions for carry, convexity, gap, liquidity, and factor purity.
- Specify terminal realization, time expiry, and evidence-based invalidation for **Fed Funds Futures and Meeting Probabilities**.

A valid **Fed Funds Futures and Meeting Probabilities** thesis with no residual pricing gap, adverse carry beyond expected payoff, or an imminent dominating catalyst is not a deployable swing.
...
Create a context object under [[00 Core Standards/17 Context Object and Permission Schema Standard]] containing the **Fed Funds Futures and Meeting Probabilities** target, cutoff, data vintages, model version, state/market distributions, rival models, leader, confirmations, horizon, half-life, permission, confidence cap, size ceiling, invalidation, technical handoff, expiry, and claim IDs.
