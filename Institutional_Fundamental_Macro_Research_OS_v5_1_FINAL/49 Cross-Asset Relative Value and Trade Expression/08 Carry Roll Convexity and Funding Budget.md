...
- Identify the new **Carry Roll Convexity and Funding Budget** information since the prior close and its source timestamp.
- Reconstruct the priced **Carry Roll Convexity and Funding Budget** baseline before reading the target move.
- Name the liquid leader closest to the **Carry Roll Convexity and Funding Budget** mechanism and one independent confirmation.
- Compare observed transmission with the **Carry Roll Convexity and Funding Budget** event/quiet-day historical distribution.
- Assign a permission and a confidence cap; record the **Carry Roll Convexity and Funding Budget** cancellation condition.
- Pass only the permission, leader, invalidation, expiry, and size ceiling to technical execution.

For **Carry Roll Convexity and Funding Budget**, fundamentals restrict the allowed trade set; they do not supply the candle trigger or authorize widening a structural stop.

## Two-to-ten-day swing translation

- Define the still-open **Carry Roll Convexity and Funding Budget** pricing gap rather than the general narrative.
- Estimate the **Carry Roll Convexity and Funding Budget** impulse half-life and its uncertainty by regime.
- Map catalysts capable of confirming, reversing, or exhausting the **Carry Roll Convexity and Funding Budget** campaign.
- Compare outright and relative expressions for carry, convexity, gap, liquidity, and factor purity.
- Specify terminal realization, time expiry, and evidence-based invalidation for **Carry Roll Convexity and Funding Budget**.

A valid **Carry Roll Convexity and Funding Budget** thesis with no residual pricing gap, adverse carry beyond expected payoff, or an imminent dominating catalyst is not a deployable swing.
...
Create a context object under [[00 Core Standards/17 Context Object and Permission Schema Standard]] containing the **Carry Roll Convexity and Funding Budget** target, cutoff, data vintages, model version, state/market distributions, rival models, leader, confirmations, horizon, half-life, permission, confidence cap, size ceiling, invalidation, technical handoff, expiry, and claim IDs.
