...
if m.get('current_stack') not in {'V16.1.0','V17.0.0','V18.0.0','V19.0.0'}: errors.append('current_stack is not a supported V16.1/V17.0/V18.0/V19.0 stack')
if m.get('current_stack') in {'V17.0.0','V18.0.0','V19.0.0'} and 'fact_constitution' not in (m.get('canonical_authorities') or {}): errors.append('V17+ fact_constitution authority missing')
if m.get('current_stack') in {'V18.0.0','V19.0.0'}:
    ...
    if m.get('current_stack')=='V19.0.0' and d2.get('direct_permission_effect')!='NONE': errors.append('V19 D2 direct permission boundary violated')
