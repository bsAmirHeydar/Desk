...
- Identify the new **Hard Data versus Surveys** information since the prior close and its source timestamp.
- Reconstruct the priced **Hard Data versus Surveys** baseline before reading the target move.
- Name the liquid leader closest to the **Hard Data versus Surveys** mechanism and one independent confirmation.
- Compare observed transmission with the **Hard Data versus Surveys** event/quiet-day historical distribution.
- Assign a permission and a confidence cap; record the **Hard Data versus Surveys** cancellation condition.
- Pass only the permission, leader, invalidation, expiry, and size ceiling to technical execution.

For **Hard Data versus Surveys**, fundamentals restrict the allowed trade set; they do not supply the candle trigger or authorize widening a structural stop.

## Two-to-ten-day swing translation

- Define the still-open **Hard Data versus Surveys** pricing gap rather than the general narrative.
- Estimate the **Hard Data versus Surveys** impulse half-life and its uncertainty by regime.
- Map catalysts capable of confirming, reversing, or exhausting the **Hard Data versus Surveys** campaign.
- Compare outright and relative expressions for carry, convexity, gap, liquidity, and factor purity.
- Specify terminal realization, time expiry, and evidence-based invalidation for **Hard Data versus Surveys**.

A valid **Hard Data versus Surveys** thesis with no residual pricing gap, adverse carry beyond expected payoff, or an imminent dominating catalyst is not a deployable swing.
