---
title: "1998 Russia LTCM and Dollar Funding"
...
cutoff: "1998-08-17 00:00 Europe/Moscow"
reference_answer: executed-internal
---

# 1998 Russia LTCM and Dollar Funding

## Benchmark object

- **Cutoff:** 1998-08-17 00:00 Europe/Moscow
- **Object:** Sovereign default, convergence leverage and funding
- **Primary mechanism:** Sovereign credit, dealer balance sheets, margin and flight to liquidity
...
A high-scoring answer must explain **Sovereign credit, dealer balance sheets, margin and flight to liquidity** without treating the target-market move as proof. It must distinguish accounting identities from estimated behavior, map the constrained balance sheet or physical system, and explain why the mechanism could amplify, reverse or expire.
...
| E03 | Measurement and institutional mechanism | [[65 Source Registry and Claim Lineage/FED_FSR — Federal Reserve — Financial Stability Report|FED_FSR — Federal Reserve — Financial Stability Report]] | Financial Stability Report vulnerability sections | Confirm coverage, timing, revisions and jurisdiction before inference. |



## Executed internal reference answer

The Russia/LTCM dossier separates sovereign default and ruble devaluation from the propagation through convergence trades, repo and derivatives margin. Positions that appeared diversified shared liquidity and spread-convergence exposure. Dealer balance sheets and counterparties became constraints, producing a flight to the most liquid collateral. The reference answer treats the Federal Reserve-facilitated private recapitalization as a response to network risk, not a guarantee against market loss.
