...
cutoff: "2020-04-20 14:30 America/New_York"
reference_answer: executed-internal
---

# April 2020 Negative WTI

## Benchmark object

- **Cutoff:** 2020-04-20 14:30 America/New_York
- **Object:** NYMEX May WTI and Cushing delivery
- **Primary mechanism:** Physical storage, expiry, delivery, liquidity and arbitrage breakdown
...
A high-scoring answer must explain **Physical storage, expiry, delivery, liquidity and arbitrage breakdown** without treating the target-market move as proof. It must distinguish accounting identities from estimated behavior, map the constrained balance sheet or physical system, and explain why the mechanism could amplify, reverse or expire.
...
The negative-WTI dossier is contract-specific. The expiring May 2020 WTI future converged toward delivery at Cushing during a demand collapse, high inventory, scarce immediately usable storage and forced position exit. The reference answer must identify the contract, expiry, delivery location and holder constraints; it must not claim that every barrel of crude or every later-dated contract had a negative economic value.
...
### Consolidated legacy note: IMF Global Financial Stability Report April 2026 Reading Map
