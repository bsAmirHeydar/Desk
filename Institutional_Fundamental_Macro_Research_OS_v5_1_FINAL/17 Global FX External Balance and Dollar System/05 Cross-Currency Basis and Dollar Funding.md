...
- Identify the new **Cross-Currency Basis and Dollar Funding** information since the prior close and its source timestamp.
- Reconstruct the priced **Cross-Currency Basis and Dollar Funding** baseline before reading the target move.
- Name the liquid leader closest to the **Cross-Currency Basis and Dollar Funding** mechanism and one independent confirmation.
- Compare observed transmission with the **Cross-Currency Basis and Dollar Funding** event/quiet-day historical distribution.
- Assign a permission and a confidence cap; record the **Cross-Currency Basis and Dollar Funding** cancellation condition.
- Pass only the permission, leader, invalidation, expiry, and size ceiling to technical execution.

For **Cross-Currency Basis and Dollar Funding**, fundamentals restrict the allowed trade set; they do not supply the candle trigger or authorize widening a structural stop.

## Two-to-ten-day swing translation

- Define the still-open **Cross-Currency Basis and Dollar Funding** pricing gap rather than the general narrative.
- Estimate the **Cross-Currency Basis and Dollar Funding** impulse half-life and its uncertainty by regime.
- Map catalysts capable of confirming, reversing, or exhausting the **Cross-Currency Basis and Dollar Funding** campaign.
- Compare outright and relative expressions for carry, convexity, gap, liquidity, and factor purity.
- Specify terminal realization, time expiry, and evidence-based invalidation for **Cross-Currency Basis and Dollar Funding**.

A valid **Cross-Currency Basis and Dollar Funding** thesis with no residual pricing gap, adverse carry beyond expected payoff, or an imminent dominating catalyst is not a deployable swing.
...
Create a context object under [[00 Core Standards/17 Context Object and Permission Schema Standard]] containing the **Cross-Currency Basis and Dollar Funding** target, cutoff, data vintages, model version, state/market distributions, rival models, leader, confirmations, horizon, half-life, permission, confidence cap, size ceiling, invalidation, technical handoff, expiry, and claim IDs.
