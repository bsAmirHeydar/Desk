...
- Identify the new **Volatility, Options, and Convexity** information since the prior close and its source timestamp.
- Reconstruct the priced **Volatility, Options, and Convexity** baseline before reading the target move.
- Name the liquid leader closest to the **Volatility, Options, and Convexity** mechanism and one independent confirmation.
- Compare observed transmission with the **Volatility, Options, and Convexity** event/quiet-day historical distribution.
- Assign a permission and a confidence cap; record the **Volatility, Options, and Convexity** cancellation condition.
- Pass only the permission, leader, invalidation, expiry, and size ceiling to technical execution.

For **Volatility, Options, and Convexity**, fundamentals restrict the allowed trade set; they do not supply the candle trigger or authorize widening a structural stop.

## Two-to-ten-day swing translation

- Define the still-open **Volatility, Options, and Convexity** pricing gap rather than the general narrative.
- Estimate the **Volatility, Options, and Convexity** impulse half-life and its uncertainty by regime.
- Map catalysts capable of confirming, reversing, or exhausting the **Volatility, Options, and Convexity** campaign.
- Compare outright and relative expressions for carry, convexity, gap, liquidity, and factor purity.
- Specify terminal realization, time expiry, and evidence-based invalidation for **Volatility, Options, and Convexity**.

A valid **Volatility, Options, and Convexity** thesis with no residual pricing gap, adverse carry beyond expected payoff, or an imminent dominating catalyst is not a deployable swing.
...
Create a context object under [[00 Core Standards/17 Context Object and Permission Schema Standard]] containing the **Volatility, Options, and Convexity** target, cutoff, data vintages, model version, state/market distributions, rival models, leader, confirmations, horizon, half-life, permission, confidence cap, size ceiling, invalidation, technical handoff, expiry, and claim IDs.
