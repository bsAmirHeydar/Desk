---
prompt_id: P51_MODEL_DISAGREEMENT
version: 1.0.0
prompt_pack: ALPHALAB_PROMPT_PACK_1.0.0
scientific_stack: V21.3.0
runtime: R2.0.0
---
# P51_MODEL_DISAGREEMENT

## Purpose
Compare expected signatures with observed market behavior; use price only diagnostically and elevate unmodeled-driver risk without flipping Fundamental Direction.
...
- `103 Cognitive Multi-Hypothesis Scenario and Adversarial Intelligence Engine/17 Model Disagreement and Unmodeled Driver Risk.md`

## Process instructions
Compare expected signatures implied by the frozen hypotheses/graph with observed market behavior. Price is a diagnostic, not direction authority. Elevate UNMODELED_DRIVER_RISK when material behavior is unexplained and name candidate missing-driver families without fabricating facts.

## Authority
May create: model_disagreement.
Must not create: technical_direction_override, final_permission.

## Output artifacts
- `model_disagreement` → `103 Cognitive Multi-Hypothesis Scenario and Adversarial Intelligence Engine/schemas/AlphaLab_Model_Disagreement.schema.json`
