...
def seal_run(vault_root,run_id,truth_state='SHADOW_LIVE'):
    ...
    ri=_artifact(rt,run_id,'research_intent',{}) or {};fp=_artifact(rt,run_id,'final_permission',{}) or {};uireq=_artifact(rt,run_id,'unified_request',{}) or {};cintent=_artifact(rt,run_id,'compiled_intent',{}) or {};cresult=_artifact(rt,run_id,'canonical_scientific_result',{}) or {}
