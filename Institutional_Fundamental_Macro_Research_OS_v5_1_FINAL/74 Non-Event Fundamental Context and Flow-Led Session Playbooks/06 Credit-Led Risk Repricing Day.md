---
title: "06 Credit-Led Risk Repricing Day"
type: playbook
status: evergreen
version: 5.0.0
created: 2026-07-29
...
Record the structural, cyclical, tactical and swing states separately. For **06 Credit-Led Risk Repricing Day**, write:
...
| Type | Meaning in 06 Credit-Led Risk Repricing Day | Treatment |
|---|---|---|
...
The live monitor for **06 Credit-Led Risk Repricing Day** is **CDX/ETF-type credit, bank equities, funding, Treasury safe-haven flow, and volatility**.
...
For **06 Credit-Led Risk Repricing Day**, distinguish:
...
A **06 Credit-Led Risk Repricing Day** move may become a two-to-ten-day campaign only when:
...
Reject or cap the **06 Credit-Led Risk Repricing Day** interpretation when:
...
```yaml
playbook: "06 Credit-Led Risk Repricing Day"
as_of:
causal_leader:
confirmations: []
permission:
