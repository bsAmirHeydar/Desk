...
- Identify the new **Weekly Macro Map** information since the prior close and its source timestamp.
- Reconstruct the priced **Weekly Macro Map** baseline before reading the target move.
- Name the liquid leader closest to the **Weekly Macro Map** mechanism and one independent confirmation.
- Compare observed transmission with the **Weekly Macro Map** event/quiet-day historical distribution.
- Assign a permission and a confidence cap; record the **Weekly Macro Map** cancellation condition.
- Pass only the permission, leader, invalidation, expiry, and size ceiling to technical execution.

For **Weekly Macro Map**, fundamentals restrict the allowed trade set; they do not supply the candle trigger or authorize widening a structural stop.

## Two-to-ten-day swing translation

- Define the still-open **Weekly Macro Map** pricing gap rather than the general narrative.
- Estimate the **Weekly Macro Map** impulse half-life and its uncertainty by regime.
- Map catalysts capable of confirming, reversing, or exhausting the **Weekly Macro Map** campaign.
- Compare outright and relative expressions for carry, convexity, gap, liquidity, and factor purity.
- Specify terminal realization, time expiry, and evidence-based invalidation for **Weekly Macro Map**.

A valid **Weekly Macro Map** thesis with no residual pricing gap, adverse carry beyond expected payoff, or an imminent dominating catalyst is not a deployable swing.
...
```mermaid
flowchart TD
    S[Macro State] --> P[Priced Baseline]
    P --> T[Unresolved Tensions]
    T --> C[Upcoming Catalysts]
    C --> R[Possible Repricing]
    R --> A[Asset Transmission]
    A --> D[Directional Permission]
    D --> I[Invalidation / Expiry]
```
