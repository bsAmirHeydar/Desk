---
title: "02 Keynesian Effective Demand and Multiplier Framework"
...
---
# 02 Keynesian Effective Demand and Multiplier Framework
...
The framework proposes that **output and employment can be demand-constrained, expectations are unstable, and fiscal/monetary policy affect realized activity**.

## What it treats as primary

Measure **income, consumption propensity, investment expectations, inventories, fiscal impulse, and slack**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** useful for demand shortfalls; simple multipliers are state-, openness-, financing-, and policy-dependent.
