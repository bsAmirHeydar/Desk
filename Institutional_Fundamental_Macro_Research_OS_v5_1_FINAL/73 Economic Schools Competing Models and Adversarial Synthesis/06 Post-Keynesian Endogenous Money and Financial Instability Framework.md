---
title: "06 Post-Keynesian Endogenous Money and Financial Instability Framework"
...
---
# 06 Post-Keynesian Endogenous Money and Financial Instability Framework
...
The framework proposes that **banks create deposits through lending, financing is endogenous, uncertainty is fundamental, and stability can breed leverage**.

## What it treats as primary

Measure **loan demand/standards, cash flows, margins of safety, sector balances, and funding structures**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** strong on institutions and Minsky dynamics; quantitative prediction and policy closure vary by model.
