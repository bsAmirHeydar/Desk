---
title: "03 New Keynesian Sticky Price and Reaction-Function Framework"
...
---
# 03 New Keynesian Sticky Price and Reaction-Function Framework
...
The framework proposes that **nominal rigidities and forward-looking expectations create real effects of monetary policy and a policy trade-off**.

## What it treats as primary

Measure **output gap, inflation expectations, wage/price rigidity, real rate gap, and policy credibility**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** operational for policy pricing; representative-agent and linear approximations can miss balance sheets and distributions.
