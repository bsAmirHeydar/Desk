---
title: "09 Real Business Cycle Technology and Intertemporal Framework"
...
---
# 09 Real Business Cycle Technology and Intertemporal Framework
...
The framework proposes that **real shocks to technology, preferences, labor, and capital propagate through optimizing responses**.

## What it treats as primary

Measure **productivity, labor input, investment, utilization, and real returns**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** disciplines supply-side analysis; weak for nominal/financial crises without extensions.
