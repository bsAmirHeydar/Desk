---
title: "04 Monetarist Money Credit and Nominal Spending Framework"
...
---
# 04 Monetarist Money Credit and Nominal Spending Framework
...
The framework proposes that **persistent nominal instability ultimately reflects money/credit conditions relative to real capacity and money demand**.

## What it treats as primary

Measure **monetary aggregates, bank credit, velocity, nominal GDP, inflation expectations, and policy regime**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** forces nominal accounting discipline; money definitions and velocity can shift sharply.
