---
title: "12 Minsky Financial Instability and Reflexivity Framework"
...
---
# 12 Minsky Financial Instability and Reflexivity Framework
...
The framework proposes that **success changes behavior, leverage, collateral, and beliefs until the system becomes vulnerable to a feedback reversal**.

## What it treats as primary

Measure **financing type, margin of safety, leverage, asset prices, collateral, and refinancing**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** powerful for fragility; turning points require concrete triggers and market plumbing.
