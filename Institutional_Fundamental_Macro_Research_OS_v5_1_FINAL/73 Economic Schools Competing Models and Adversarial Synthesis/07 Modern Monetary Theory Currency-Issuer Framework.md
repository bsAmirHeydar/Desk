---
title: "07 Modern Monetary Theory Currency-Issuer Framework"
...
---
# 07 Modern Monetary Theory Currency-Issuer Framework
...
The framework proposes that **a sovereign currency issuer faces real-resource and inflation constraints more directly than household-style financing constraints**.

## What it treats as primary

Measure **currency sovereignty, fiscal operations, reserves, inflation capacity, external constraint, and political authority**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** clarifies operational plumbing; does not eliminate inflation, FX, institutional, or political constraints.
