---
title: "08 Fiscal Theory of the Price Level"
...
---
# 08 Fiscal Theory of the Price Level
...
The framework proposes that **the price level helps equilibrate the real value of government liabilities when fiscal backing and monetary policy interact**.

## What it treats as primary

Measure **primary-surplus expectations, debt duration, monetary liabilities, inflation, and credibility**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** useful for fiscal-monetary regimes; empirical separation from conventional channels is challenging.
