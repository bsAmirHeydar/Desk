---
title: "10 Financial Accelerator and Balance-Sheet Recession Framework"
...
---
# 10 Financial Accelerator and Balance-Sheet Recession Framework
...
The framework proposes that **borrower net worth, collateral, cash flow, and lender standards amplify shocks and can suppress demand despite low policy rates**.

## What it treats as primary

Measure **leverage, collateral, debt service, credit spreads, standards, and deleveraging**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** essential for housing/banking crises; requires sector-specific balance sheets.
