---
title: "11 Stock-Flow Consistent Sectoral Balance Framework"
...
---
# 11 Stock-Flow Consistent Sectoral Balance Framework
...
The framework proposes that **all financial stocks and flows must reconcile across households, firms, government, banks, and foreign sectors**.

## What it treats as primary

Measure **sector net lending, financial accounts, debt, income, interest, and valuation changes**. Specify which variables are primitive, which are endogenous, which adjust through prices, which adjust through quantities, and which institutions close the model.
...
**Critique:** prevents impossible stories; accounting identities alone do not supply behavioral timing.
