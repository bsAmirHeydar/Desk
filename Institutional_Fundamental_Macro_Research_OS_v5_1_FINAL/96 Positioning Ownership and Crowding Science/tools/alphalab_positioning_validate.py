...
p=argparse.ArgumentParser(); p.add_argument('--state',required=True); a=p.parse_args(); x=json.loads(Path(a.state).read_text(encoding='utf-8')); e=[]
req=['instrument','as_of_utc','authority_mode','coverage_state','crowding_state','fragility_state','evidence_ids','permission_effect_v18']
for k in req:
