...
MACHINE_GATE_ORDER=('P01_FROZEN','P02_3_2_6_FROZEN','P03_3_3_6_FROZEN','P04_ACCEPTANCE_PASS','TRUE_FORWARD_SAMPLE_PROVISIONAL','ZERO_INTEGRITY_FAILURES','EXPLICIT_OPERATOR_APPROVAL')
...
def collect_machine_gate_results(phase_root,commissioning_state,approve=False):
    ...
    return {
      ...
      'TRUE_FORWARD_SAMPLE_PROVISIONAL':commissioning_state.get('sample_state')=='PROVISIONAL',
      'ZERO_INTEGRITY_FAILURES':commissioning_state.get('integrity_failures',0)==0,
      'EXPLICIT_OPERATOR_APPROVAL':approve is True,
      '_evidence':{'P01':r1,'P02':r2,'P03':r3,'P04':r4}
    }
