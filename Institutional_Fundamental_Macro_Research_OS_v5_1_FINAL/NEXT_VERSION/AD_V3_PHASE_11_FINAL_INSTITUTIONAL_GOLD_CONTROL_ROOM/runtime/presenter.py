...
MATERIAL=[('causal_direction','جهت'),('pressure_strength','قدرت فشار'),('dominance_state','غلبه'),('dominant_root','ریشه غالب'),('permission_candidate','مجوز پژوهشی'),('edge_state','Edge'),('consumption','مصرف'),('fragility','شکنندگی'),('contradiction','تناقض')]
