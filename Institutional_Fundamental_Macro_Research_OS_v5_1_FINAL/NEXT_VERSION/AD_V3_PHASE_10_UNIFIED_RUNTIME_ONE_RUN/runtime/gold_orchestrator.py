...
def _paths(repo):
    ...
    return {k:n/v for k,v in {'p02':'AD_V3_PHASE_02_TOTAL_LIVE_DATA_OBSERVABILITY_FABRIC','p03':'AD_V3_PHASE_03_CAUSAL_GOLD_BRAIN_DECISION_ENGINE','p04':'AD_V3_PHASE_04_CONTROL_ROOM_TRUE_FORWARD_COMMISSIONING','p06':'AD_V3_PHASE_06_GOVERNED_SEMANTIC_INTELLIGENCE','p07':'AD_V3_PHASE_07_LIVE_INTRADAY_GOLD_DATA_KERNEL','p08':'AD_V3_PHASE_08_DECISION_SCIENCE_CALIBRATION','p09':'AD_V3_PHASE_09_TRUE_FORWARD_VALIDATION_2_0','p10':'AD_V3_PHASE_10_UNIFIED_RUNTIME_ONE_RUN','p11':'AD_V3_PHASE_11_FINAL_INSTITUTIONAL_GOLD_CONTROL_ROOM'}.items()}
...
def _versions(paths):
    out={}
    for k in ('p03','p06','p07','p08','p09','p10','p11'):
