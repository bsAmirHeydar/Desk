...
if m.get('current_stack')!='V18.0.0':e.append('CURRENT_STACK_NOT_V18')
...
if d2.get('final_permission_effect')!='NONE':e.append('D2_PREMATURE_PERMISSION_EFFECT')
if d2.get('d3_promotion_state')!='NOT_PROMOTED':e.append('D3_PREMATURE_PROMOTION')
