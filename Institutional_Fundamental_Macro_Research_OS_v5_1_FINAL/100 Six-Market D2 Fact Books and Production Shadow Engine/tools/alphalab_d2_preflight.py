...
if m.get('current_stack') not in {'V18.0.0','V19.0.0','V20.0.0','V21.0.0','V21.1.0'}:e.append('CURRENT_STACK_NOT_V18_TO_V21')
...
if m.get('current_stack') in {'V19.0.0','V20.0.0','V21.0.0','V21.1.0'} and d2.get('direct_permission_effect')!='NONE':e.append('D2_DIRECT_PERMISSION_EFFECT')

if m.get('current_stack')=='V18.0.0' and d2.get('d3_promotion_state')!='NOT_PROMOTED':e.append('D3_PREMATURE_PROMOTION')
if m.get('current_stack') in {'V19.0.0','V20.0.0','V21.0.0','V21.1.0'} and d2.get('d3_promotion_state')!='PROMOTED_VIA_MODULE_101_ONLY':e.append('D3_PROMOTION_PATH_INVALID')
