---
title: "23 Gold Monetary and Physical Engine"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 23 Gold Monetary and Physical Engine

## Mission

Integrate real rates, dollar, monetary credibility, reserve allocation, ETF flows, futures, options and physical demand.
...
Phase 12, Phase 15, Phase 22

## Build scope

- Gold driver-state model.
- Central-bank and ETF flow database.
- Regional premium and futures-positioning layer.
...
- Regime-dependent sensitivities are measured.
- Safe-haven, liquidation and monetary-demand channels are discriminated.
- Historical decisions are tested point in time.
