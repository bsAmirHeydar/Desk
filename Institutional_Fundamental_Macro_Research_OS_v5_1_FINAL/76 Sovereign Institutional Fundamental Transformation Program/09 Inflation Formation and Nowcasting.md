---
title: "09 Inflation Formation and Nowcasting"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 09 Inflation Formation and Nowcasting

## Mission

Model inflation as a system of goods, shelter, wages, productivity, margins, administered prices, exchange rates, commodities and expectations.
...
Phase 05, Phase 07, Phase 08

## Build scope

- Component-level inflation pipeline.
- Nowcasts with contribution decomposition.
- Persistence, breadth and regime diagnostics.
...
- First-release forecast evaluation by component.
- Pass-through estimates include uncertainty and state dependence.
- Policy-relevant and asset-relevant measures are separated.
