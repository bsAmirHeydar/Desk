---
title: "37 Governance Organization and Research Incentives"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 37 Governance Organization and Research Incentives

## Mission

Design CIO, PM, economist, strategist, data, model-risk, execution and independent-risk responsibilities.
...
Phase 01, Phase 34, Phase 35, Phase 36

## Build scope

- Decision-rights matrix.
- Investment-committee and model-committee charters.
- Incentive and error-reporting framework.
...
- No analyst approves their own material model change.
- Research dissent remains visible.
- Compensation does not reward hidden tail risk or outcome-only attribution.
