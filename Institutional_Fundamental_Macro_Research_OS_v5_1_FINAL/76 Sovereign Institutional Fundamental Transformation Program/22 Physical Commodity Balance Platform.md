---
title: "22 Physical Commodity Balance Platform"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 22 Physical Commodity Balance Platform

## Mission

Build bottom-up balances for production, trade, inventories, processing, transport, storage, quality and location.
...
- Commodity master and unit-conversion layer.
- Physical balance and revision database.
- Curve, basis, freight and convenience-yield analytics.
...
- Balances reconcile within disclosed errors.
- Inventory quality and location are explicit.
- Financial positioning is separated from physical tightness.
