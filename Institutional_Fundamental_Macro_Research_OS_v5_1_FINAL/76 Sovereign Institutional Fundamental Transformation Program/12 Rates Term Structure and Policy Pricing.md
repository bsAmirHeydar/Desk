---
title: "12 Rates Term Structure and Policy Pricing"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 12 Rates Term Structure and Policy Pricing

## Mission

Build curve-construction, policy-probability, term-premium, real-rate and inflation-compensation engines.
...
Phase 05, Phase 06, Phase 11

## Build scope

- OIS and futures curve service.
- Nominal and real zero curves.
- Affine and survey-augmented term-premium models.
...
- Curves reconcile to instrument cash flows.
- Model uncertainty and benchmark disagreement are visible.
- Historical curves are point-in-time and contract-correct.
