---
title: "06 Entity Instrument and Source Master"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 06 Entity Instrument and Source Master

## Mission

Create canonical identities for countries, institutions, issuers, securities, contracts, curves, commodities, data series and source documents.
...
- Entity master with aliases and corporate actions.
- Instrument master with specifications and historical changes.
- Source master with licensing and methodology metadata.
...
- No ambiguous identifiers in research artifacts.
- Historical mappings are versioned.
- Every observation and claim resolves to canonical entities.
