---
title: "21 Credit Markets Default and Recovery"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 21 Credit Markets Default and Recovery

## Mission

Model spreads, expected loss, liquidity premium, capital structure, covenants, maturity walls, defaults and recoveries.
...
Phase 12, Phase 17, Phase 19

## Build scope

- Bond and CDS reference-data platform.
- Default and recovery models.
- Issuer and sector refinancing map.
...
- Spread decomposition includes rates, expected loss and liquidity.
- Covenants and deliverability are instrument-correct.
- Stress and recovery assumptions are documented.
