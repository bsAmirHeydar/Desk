---
title: "35 Portfolio Construction and Independent Risk"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 35 Portfolio Construction and Independent Risk

## Mission

Convert research into diversified, liquid and stress-resilient portfolios with independent challenge and veto.
...
Phase 18, Phase 21, Phase 26, Phase 27, Phase 34

## Build scope

- Factor and hidden-beta map.
- Scenario P&L and liquidity stress.
- Capital-allocation and concentration framework.
...
- Positions are aggregated by common causal driver.
- Hedges are tested for basis and liquidity failure.
- Independent risk can reduce or reject deployment.
