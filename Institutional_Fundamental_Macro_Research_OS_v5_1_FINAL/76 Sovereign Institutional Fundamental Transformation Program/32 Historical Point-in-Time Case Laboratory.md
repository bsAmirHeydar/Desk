---
title: "32 Historical Point-in-Time Case Laboratory"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 32 Historical Point-in-Time Case Laboratory

## Mission

Replace case templates with complete reconstructions of information, pricing, policy, liquidity, positioning and outcomes.
...
Phase 05, Phase 12, Phase 15, Phase 20, Phase 21, Phase 22, Phase 26

## Build scope

- Event clock and archive package.
- Decision replay and ex-post audit layers.
- Comparable-case taxonomy.
...
- Cases include original releases and market snapshots.
- Ex-ante and ex-post evidence remain separate.
- Attribution includes rival explanations and uncertainty.
