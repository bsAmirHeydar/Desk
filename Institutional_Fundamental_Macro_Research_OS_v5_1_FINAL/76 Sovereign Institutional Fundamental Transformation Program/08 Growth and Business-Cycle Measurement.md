---
title: "08 Growth and Business-Cycle Measurement"
type: program-phase
status: planned
version: 6.0.0
created: 2026-07-29
...
---
# 08 Growth and Business-Cycle Measurement

## Mission

Build a production growth-state system combining hard data, surveys, sector detail, diffusion, inventories and financial conditions.
...
- Growth data dictionary.
- Bridge equations, mixed-frequency models and dynamic factors.
- Turning-point and recession-probability models.
...
- Pseudo-real-time forecasts beat simple benchmarks or are retired.
- News contributions are release-specific.
- State uncertainty and revision sensitivity are published.
