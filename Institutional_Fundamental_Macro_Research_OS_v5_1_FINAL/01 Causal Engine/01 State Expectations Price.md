...
- Identify the new **State, Expectations, and Price** information since the prior close and its source timestamp.
- Reconstruct the priced **State, Expectations, and Price** baseline before reading the target move.
- Name the liquid leader closest to the **State, Expectations, and Price** mechanism and one independent confirmation.
- Compare observed transmission with the **State, Expectations, and Price** event/quiet-day historical distribution.
- Assign a permission and a confidence cap; record the **State, Expectations, and Price** cancellation condition.
- Pass only the permission, leader, invalidation, expiry, and size ceiling to technical execution.

For **State, Expectations, and Price**, fundamentals restrict the allowed trade set; they do not supply the candle trigger or authorize widening a structural stop.

## Two-to-ten-day swing translation

- Define the still-open **State, Expectations, and Price** pricing gap rather than the general narrative.
- Estimate the **State, Expectations, and Price** impulse half-life and its uncertainty by regime.
- Map catalysts capable of confirming, reversing, or exhausting the **State, Expectations, and Price** campaign.
- Compare outright and relative expressions for carry, convexity, gap, liquidity, and factor purity.
- Specify terminal realization, time expiry, and evidence-based invalidation for **State, Expectations, and Price**.

A valid **State, Expectations, and Price** thesis with no residual pricing gap, adverse carry beyond expected payoff, or an imminent dominating catalyst is not a deployable swing.
...
Create a context object under [[00 Core Standards/17 Context Object and Permission Schema Standard]] containing the **State, Expectations, and Price** target, cutoff, data vintages, model version, state/market distributions, rival models, leader, confirmations, horizon, half-life, permission, confidence cap, size ceiling, invalidation, technical handoff, expiry, and claim IDs.
...
Price includes the expected state, compensation for uncertainty, technical constraints, and marginal flow.
