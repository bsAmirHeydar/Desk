...
m=json.loads((R/'CURRENT_PRODUCTION_MANIFEST.json').read_text());ck('stack_v20_or_v21',m.get('current_stack') in {'V20.0.0','V21.0.0'},m.get('current_stack'));ck('direction_fundamental_only',m.get('decision_authority',{}).get('direction')=='FUNDAMENTAL_ONLY')
