...
Credit pricing combines expected default loss, recovery uncertainty, downgrade/migration, liquidity, risk premium, technical supply, and embedded options. Probabilistic research requires explicit priors, likelihoods, posterior distributions, calibration, resolution, and decision utility.
...
- Identify the new **Default Probability Recovery and Distress Ratios** information since the prior close and its source timestamp.
- Reconstruct the priced **Default Probability Recovery and Distress Ratios** baseline before reading the target move.
- Name the liquid leader closest to the **Default Probability Recovery and Distress Ratios** mechanism and one independent confirmation.
- Compare observed transmission with the **Default Probability Recovery and Distress Ratios** event/quiet-day historical distribution.
- Assign a permission and a confidence cap; record the **Default Probability Recovery and Distress Ratios** cancellation condition.
- Pass only the permission, leader, invalidation, expiry, and size ceiling to technical execution.

For **Default Probability Recovery and Distress Ratios**, fundamentals restrict the allowed trade set; they do not supply the candle trigger or authorize widening a structural stop.

## Two-to-ten-day swing translation

- Define the still-open **Default Probability Recovery and Distress Ratios** pricing gap rather than the general narrative.
- Estimate the **Default Probability Recovery and Distress Ratios** impulse half-life and its uncertainty by regime.
- Map catalysts capable of confirming, reversing, or exhausting the **Default Probability Recovery and Distress Ratios** campaign.
- Compare outright and relative expressions for carry, convexity, gap, liquidity, and factor purity.
- Specify terminal realization, time expiry, and evidence-based invalidation for **Default Probability Recovery and Distress Ratios**.

A valid **Default Probability Recovery and Distress Ratios** thesis with no residual pricing gap, adverse carry beyond expected payoff, or an imminent dominating catalyst is not a deployable swing.
...
Create a context object under [[00 Core Standards/17 Context Object and Permission Schema Standard]] containing the **Default Probability Recovery and Distress Ratios** target, cutoff, data vintages, model version, state/market distributions, rival models, leader, confirmations, horizon, half-life, permission, confidence cap, size ceiling, invalidation, technical handoff, expiry, and claim IDs.
