...
This Vault excludes non-fundamental price-pattern methods. Price data are used only as observations of valuation, market-implied expectations, response, volatility, liquidity, basis, flow, cost or realized outcome. Read [[00 Core Standards/19 Fundamental-Only Research Boundary and Implementation Standard]].

## Core doctrine

```text
Definitions and accounting identities
→ competing theories and causal mechanisms
→ measurement and historical evidence
→ states, expectations and market-implied information
→ cross-asset and cross-country transmission
→ structural-to-event horizon synthesis
→ scenarios, uncertainty and fundamental conclusions
→ critique, revision and continuous scholarly improvement
```

## Start here

1. [[00 Core Standards/00 Core Standards MOC]]
2. [[01 COVERAGE MATRIX]]
...
### Foundations and macro systems

- [[00 Orientation/00 Orientation MOC]]
...
## Alpha Runtime R4
Scientific certification and reproducibility hardening is installed as Runtime R4.0.0. Offline runtime certification is distinct from provider/source environment certification and from strategy profitability.
