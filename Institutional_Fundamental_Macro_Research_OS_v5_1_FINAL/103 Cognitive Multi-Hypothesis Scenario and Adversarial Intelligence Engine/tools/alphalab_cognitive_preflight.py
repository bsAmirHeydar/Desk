...
if m.get('current_stack')!='V21.1.0':e.append('CURRENT_STACK_NOT_V21_1')
...
if (m.get('d4_forward_validation') or {}).get('authority_mode')!='GOVERNANCE_ENFORCED':e.append('D4_AUTHORITY_DRIFT')
...
for name,args in cmds:
 ...
 if q.returncode:e.append(name+'_FAIL '+(q.stdout+q.stderr)[-2600:])
